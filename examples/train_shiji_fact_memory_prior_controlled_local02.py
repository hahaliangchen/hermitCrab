"""Run the local-strong gradient experiment with a 0.02 background update."""
...
if __name__ == "__main__":
    ...
    output_dir = root / "outputs" / "bert-mlm-fact-memory-shiji-prior-controlled-local02-256"
        ...
        json.dumps(
            {
                ...
                "background_weight": 0.02,
                "non_feature_parameter_weight": 0.02,
                "replay_weight": 0.5,
                "description": (
